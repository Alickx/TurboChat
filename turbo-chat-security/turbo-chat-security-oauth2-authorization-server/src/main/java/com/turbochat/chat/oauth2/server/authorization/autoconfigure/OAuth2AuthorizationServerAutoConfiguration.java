...
import com.turbochat.chat.oauth2.server.authorization.OAuth2AuthorizationObjectMapperCustomizer;
import com.turbochat.chat.oauth2.server.authorization.config.OAuth2AuthorizationServerSecurityFilterChainBuilder;
import com.turbochat.chat.oauth2.server.authorization.config.TurboChatOAuth2AuthorizationServerSecurityFilterChainBuilder;
...
import com.turbochat.chat.oauth2.server.authorization.token.TurboChatOAuth2TokenCustomizer;
...
public class OAuth2AuthorizationServerAutoConfiguration {
	...
	public OAuth2AuthorizationServerSecurityFilterChainBuilder oAuth2AuthorizationServerSecurityFilterChainBuilder(
		...
		return new TurboChatOAuth2AuthorizationServerSecurityFilterChainBuilder(
	...
	public OAuth2TokenCustomizer<OAuth2TokenClaimsContext> oAuth2TokenCustomizer() {
		return new TurboChatOAuth2TokenCustomizer();
	}
