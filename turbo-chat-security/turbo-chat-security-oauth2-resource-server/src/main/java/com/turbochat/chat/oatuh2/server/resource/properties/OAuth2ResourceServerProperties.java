package com.turbochat.chat.oatuh2.server.resource.properties;
...
/**
 * @Description 资源服务器的配置文件，用于配置 token 鉴定方式。
 * @Date 2023/7/19 14:11
 * @Created by Alickx
 */
@Getter
@Setter
@ConfigurationProperties(prefix = "turbochat.security.oauth2.resource-server")
