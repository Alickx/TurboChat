package com.turbochat.chat.oatuh2.server.resource.introspection;

import cn.hutool.core.collection.CollUtil;
import com.turbochat.chat.common.security.constant.TokenAttributeNameConstants;
import com.turbochat.chat.common.security.constant.UserAttributeNameConstants;
 ...
 * @Created by Alickx
 */
public class TurboChatRemoteOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	 ...
	 */
	public TurboChatRemoteOpaqueTokenIntrospector(String introspectionUri, String clientId, String clientSecret) {
	 ...
	 */
	public TurboChatRemoteOpaqueTokenIntrospector(String introspectionUri, RestOperations restOperations) {
		Assert.notNull(introspectionUri, "introspectionUri cannot be null");
